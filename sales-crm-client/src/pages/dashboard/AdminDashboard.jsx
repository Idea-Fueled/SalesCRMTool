            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-12 gap-6">
                ...
                <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col min-h-[400px] xl:col-span-4">
                    ...
                    <div className="flex-1 overflow-y-auto pr-2 space-y-4">
                        ...
                        {topDeals.length === 0 && (
                            <div className="h-full flex items-center justify-center text-sm text-gray-400 font-bold  tracking-widest text-[10px] opacity-60"> 'No ' + $args[0].Groups[1].Value.ToLower() + ' found'  for this period</div>
                        )}
                    </div>
                </div>
