                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6">
                    ...
                    <div className="min-w-0">
                        <div className="flex items-center gap-3 mb-1">
                            ...
                            <RankBadge score={company.aiScore} tier={company.aiTier} />
                        </div>
                        ...
                        <div className="p-6 space-y-5">
                            ...
                            <div className="space-y-1">
                                ...
                                {company.website ? (
                                    ...
                                    <p className="text-sm font-bold text-gray-300 ">No website</p>
                                )}
                            </div>
                            <div className="space-y-1">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest flex items-center gap-1.5">
                            ...
                            <div className="space-y-1">
                                ...
                                {company.email ? (
                                    ...
                                    <p className="text-sm font-bold text-gray-300 ">No email on file</p>
                                )}
                            </div>
                            <div className="space-y-1">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest flex items-center gap-1.5">
                            ...
                            <div className="space-y-1 pt-2 border-t border-gray-50">
                                ...
                                <div className="p-4 bg-gray-50/50 rounded-xl border border-gray-100 text-[13px] text-gray-800 leading-relaxed whitespace-pre-wrap shadow-inner max-h-[300px] overflow-y-auto">
                                    {company.notes ? company.notes : <span className="text-gray-400 ">No notes yet. Add a remark from the right panel.</span>}
                                </div>
                            </div>
