    ...
    return (
        <div className="p-4 sm:p-6 max-w-screen-xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                {[
                    ...
                    <div key={s.label} onClick={s.onClick} className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 flex items-start gap-4 cursor-pointer hover:shadow-md active:scale-95 transition-all duration-300 group">
                        <div className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0 bg-red-600 text-white shadow-md shadow-red-100 group-hover:scale-110 transition-transform">
                            <s.icon size={20} />
                        </div>
                        <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6">
                <div className="lg:col-span-8 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden flex flex-col">
