                ...
                <form onSubmit={handleSubmit} noValidate className="px-6 py-5 space-y-4 overflow-y-auto custom-scrollbar-premium">
                    ...
                    <div className="flex flex-col items-center pb-2">
                        <div className="relative">
                            ...
                            <label className="absolute bottom-0 right-0 p-1.5 bg-red-600 text-white rounded-full cursor-pointer shadow-lg hover:bg-red-700 transition transform hover:scale-110 active:scale-95 z-10">
                        ...
                        <p className="text-[10px] text-gray-400 mt-2 font-medium">Click + to upload photo</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            <input name="address" value={form.address} onChange={handleChange}
                                className={inputClass(false)} placeholder="123 Sales St, NY" />
                        </div>
                    </div>
                    {!isEdit && (
                        <div>
